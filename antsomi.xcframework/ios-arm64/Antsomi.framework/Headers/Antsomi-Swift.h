...
#ifndef ANTSOMI_SWIFT_H
#define ANTSOMI_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Antsomi",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC7Antsomi7Antsomi")
...
SWIFT_CLASS("_TtC7Antsomi26AntsomiNotificationService")
...
SWIFT_CLASS("_TtC7Antsomi31AntsomiUNUserNotificationCenter")
...
SWIFT_CLASS("_TtC7Antsomi8AppInbox")
...
SWIFT_CLASS("_TtC7Antsomi7Context")
...
SWIFT_CLASS("_TtC7Antsomi19UserDefaultsManager")
